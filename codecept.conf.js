...
exports.config = {
  tests:
    "./steps/*_steps.js" /** Indica donde se encuentran las pruebas a ejecutar */,
  output:
    "./output" /** indica donde se guardaran los resultados de las pruebas*/,

  helpers: {
    /** Ayudantes para realizar las acciones, configura el motor de automatizacion */
    Playwright: {
      browser: "chromium" /** Navegador que se va a utilizar */,
      url: "https://www.telcel.com" /** Url de los casos a probar */,
      show: !process.env
        .CI /** En local muestra el navegador; en CI (GitHub Actions) corre headless */,
  ...
  include: {
    ...
    rickMortyMockPage:
      "./pages/rickMortyMockPage.js" /** Page Object para demo de Network Mocking */,
    rickMortyEpisodiosPage:
      "./pages/rickMortyEpisodiosPage.js" /** Page Object para demo de Network Mocking */,
  },
  ...
  plugins: {
    /**Son las funcionalidades extra */
    allure: {
      /** Generador de reportes */ enabled: true,
  ...
  bootstrap:
    null /**Archivo opcional que se ejecuta antes de realizar las pruebas */,
