...
class SearchPage {
  ...
  async validateDurationSpan() {
    ...
    I.say("Existe el campo de duración");
  }
  ...
  async validateHiddenDuration() {
    ...
    I.say("El campo de duración está oculto");
  }
  ...
  async validateDurationFormat() {
    ...
    I.say(`Texto de duración: ${durationText.trim()}`);
    expect(
      durationPattern.test(durationText.trim()),
      "El formato de duración no es válido"
    ).to.be.true;
    I.say("El formato de duración es válido:");
  }
}
