const { I } = inject();
const { URL_YOUTUBE, MOCK_CRISTIANO } = require('../mockedData/karaoke.ts');
...
Then("visualizo videos de karaoke", () => {
  I.seeElement('//yt-formatted-string[contains(translate(text(), "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"), "karaoke")]');
});