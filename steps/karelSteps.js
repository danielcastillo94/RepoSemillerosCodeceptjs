...
When(
  /^El usuario da click en Menú, muestra el submenú y selecciona "Plan de Renta"$/,
  () => {
    // interaccion con el menú
    karelPage.accedermenu();
  },
);

When(/^El usuario da click en algun plan$/, () => {
  //selecciona algun plan
...
Then(
  /^El usuario puede ver la imagen, especificaciones y precio del equipo$/,
  () => {
